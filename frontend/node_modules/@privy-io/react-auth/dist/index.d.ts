...
import { C as Chain, B as BaseConnectedWallet, W as WalletClientType, R as RpcConfig, a as ConnectorType, P as PrivyProxyProvider, E as Embedded1193Provider, b as ConnectedWalletMetadata, c as WalletBranding, d as WalletListEntry, e as ExternalWalletsConfig, f as EIP1193Provider, U as User, O as OAuthTokens, g as OAuthProviderType, M as MoonpaySignRequest, h as MoonpaySignResponse, i as PrivyServerConfig, j as PrivyFarcasterSignerInitResponse, k as PrivyClientConfig, l as ConnectWalletModalOptions, L as LoginModalOptions, m as CreateWalletOptions, n as Wallet, S as SetWalletRecoveryOptions, o as SignMessageModalUIOptions, p as SignTypedDataParams, q as MfaMethod, r as UnsignedTransactionRequest, s as SendTransactionModalUIOptions, F as FundWalletConfig, T as TransactionReceipt, t as ConnectedWallet, u as PrivyIframeErrorTypesType, v as PrivyErrorCode, w as LoginMethod, x as LinkedAccountWithMetadata, y as UserRecoveryMethod, z as FundingMethod, A as LoginWithCode, D as OtpFlowState, G as ConnectedSolanaWallet, H as UnsignedTransactionRequestWithChainId, I as CustomAuthFlowState } from './types-1f13692b.js';
export { a7 as Apple, ah as AppleOAuthWithMetadata, J as AsExternalProvider, ap as ContractUIOptions, aa as CrossAppAccount, ak as CrossAppAccountWithMetadata, a4 as Discord, ad as DiscordOAuthWithMetadata, am as Email, $ as EmailWithMetadata, at as Farcaster, ai as FarcasterWithMetadata, a5 as Github, ae as GithubOAuthWithMetadata, a2 as Google, ab as GoogleOAuthWithMetadata, a6 as LinkedIn, ag as LinkedInOAuthWithMetadata, av as LoginMethodOrderOption, N as MessageTypes, Q as MoonpayConfig, V as MoonpayCurrencyCode, ar as MoonpayFundingConfig, X as MoonpayPaymentMethod, aq as NativeFundingConfig, _ as NonEmptyArray, au as Passkey, al as PasskeyWithMetadata, an as Phone, a0 as PhoneWithMetadata, as as PriceDisplayOptions, Y as Quantity, a9 as Telegram, aj as TelegramWithMetadata, a8 as Tiktok, af as TiktokOAuthWithMetadata, Z as TransactionLog, ao as TransactionUIOptions, a3 as Twitter, ac as TwitterOAuthWithMetadata, K as TypedMessage, a1 as WalletWithMetadata } from './types-1f13692b.js';
...
declare abstract class WalletConnector extends EventEmitter<ConnectorEvents> {
     ...
     */
    buildConnectedWallet(address: string, chainId: string, meta: ConnectedWalletMetadata, imported: boolean): BaseConnectedWallet;
    /**
...
declare class EmbeddedWalletConnector extends WalletConnector {
