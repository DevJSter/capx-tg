...
var c = (e, t, s) => (ce(e, typeof t != "symbol" ? t + "" : t, s), s);
function St(e, t) {
  let s;
  const n = () => {
...
var we = "ERR_UNKNOWN_ENV";
var ge = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var fe = "ERR_TIMED_OUT";
var be = "ERR_UNEXPECTED_TYPE";
var xt = "ERR_PARSE";
var me = "ERR_NAVIGATION_LIST_EMPTY";
var ve = "ERR_NAVIGATION_CURSOR_INVALID";
var bn = "ERR_NAVIGATION_ITEM_INVALID";
var mn = "ERR_SSR_INIT";
...
var Lt = A((e) => e instanceof Date ? e : new Date(R().parse(e) * 1e3), "Date");
function ut(e, t) {
  return new G((s) => {
...
var gs = l(
  ({ postEvent: e, version: t }) => new ws(false, t, e)
);
...
var Es = l(
  ...
  ({
    postEvent: e,
    state: t = { isVerticalSwipeEnabled: true },
    version: s
...
function As(e = true) {
  ...
  return B("iframe_ready", { reload_supported: true }), s;
}
function ks() {
...
async function Cn() {
  if (It(window))
    return true;
  try {
    return await w({ method: "web_app_request_theme", event: "theme_changed", timeout: 100 }), true;
  } catch {
    return false;
  }
}
...
function _(e) {
  function t(n) {
    const r = Ds(), [i, o] = (0, import_react.useState)(
      n ? void 0 : () => {
        if (ks())
